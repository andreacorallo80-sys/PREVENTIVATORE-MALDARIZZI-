...
if "lista_preventivi" not in st.session_state: st.session_state["lista_preventivi"] = [] # Per Preventivatore Verticale
if "lista_fascicolo" not in st.session_state: st.session_state["lista_fascicolo"] = []   # Per Carrello Griglia Orizzontale
...
if check_password():
    ...
    # ==========================================
    # SEZIONE 2: PREVENTIVATORE (STAMPA VERTICALE)
    # ==========================================
            ...
            with col_stampa:
                if st.button("🚀 STAMPA PREVENTIVO UNICO"):
                    ...
                    for i, p in enumerate(st.session_state["lista_preventivi"]):
                        ...
                        # --- STRINGA DEI SERVIZI COMPLETA NEL PDF VERTICALE ---
                        serv_list = [
